...
3. Użytkownik przechodzi do widoku generowania fiszek, gdzie wprowadza tekst i inicjuje proces generowania.
4. Po wygenerowaniu fiszek, użytkownik trafia do widoku recenzji fiszek, gdzie może je edytować, akceptować lub odrzucać.
5. Użytkownik może przejść do panelu użytkownika, aby zarządzać kontem lub rozpocząć sesję powtórkową (quiz).
6. Przepływy błędne, np. błędy walidacji czy problemy z komunikacją API, są obsługiwane przez komunikaty inline i powiadomienia toast.

## 4. Układ i struktura nawigacji
- Nawigacja jest umieszczona w stałym menu, znajdującym się na górze lub w bocznym pasku.
- Główne elementy menu: Dashboard, Generowanie fiszek, Recenzja fiszek, Panel użytkownika, Sesja powtórkowa.
